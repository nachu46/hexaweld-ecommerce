...
const SOURCE_LABELS = {
    ...
    form: { label: 'Quote Form', color: 'bg-slate-100 text-slate-800 border-slate-200' },
        ...
        <div className="min-h-screen bg-gray-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                    ...
                    <button
                        onClick={exportCSV}
                        className="inline-flex items-center gap-2 px-4 py-2.5 bg-white border border-gray-200 hover:border-slate-300 text-gray-700 hover:text-[#007AFF] text-sm font-medium rounded-lg transition-all shadow-sm"
                    >
                ...
                <div className="grid grid-cols-3 gap-4 mb-6">
                    {[
                        { label: 'WhatsApp Clicks', count: totalBySource('whatsapp'), color: 'bg-emerald-50 border-emerald-200 text-emerald-700' },
                        { label: 'Quote Requests', count: totalBySource('form'), color: 'bg-slate-50 border-slate-200 text-slate-800' },
                ...
                <div className="flex flex-wrap gap-3 mb-5">
                    <div className="relative flex-1 min-w-[200px]">
                        ...
                        <input
                            ...
                            className="w-full pl-9 pr-4 py-2.5 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/30 focus:border-blue-500 bg-white"
                            value={search}
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <td className="px-4 py-3 text-xs text-gray-600 space-y-1">
                                                    {e.customerPhone && (
                                                        <a href={`tel:${e.customerPhone}`} className="flex items-center gap-1 hover:text-[#007AFF] transition-colors">
                                                            <Phone className="w-3 h-3" />{e.customerPhone}
                                                        </a>
                                                    )}
                                                    {e.customerEmail && (
                                                        <a href={`mailto:${e.customerEmail}`} className="flex items-center gap-1 hover:text-[#007AFF] transition-colors">
